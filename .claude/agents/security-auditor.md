...
curl -s -H "Authorization: token $(cat ~/.config/gitea/token)" \
  "https://github.com/api/v1/repos/owner/repo/issues"
...
REPOS=$(curl -s -H "Authorization: token ${TOKEN}" \
  "https://github.com/api/v1/users/fortemi/repos")

ISSUES=$(curl -s -H "Authorization: token ${TOKEN}" \
  "https://github.com/api/v1/repos/fortemi/fortemi/issues")
