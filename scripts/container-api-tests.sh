#!/usr/bin/env bash
# container-api-tests.sh - Comprehensive API test suite for matric-memory container
#
# Validates the full API surface of a running matric-memory instance.
...
#                 In CI/DinD: "docker exec matric-test-api curl"
...
#   CURL_CMD="docker exec matric-test-api curl" bash scripts/container-api-tests.sh
#
#   # Verbose mode
...
echo ""
echo "======================================================================"
echo "  CONTAINER API TEST RESULTS"
echo "======================================================================"
echo ""
echo "  Total:  $TOTAL"
echo "  Passed: $PASS"
