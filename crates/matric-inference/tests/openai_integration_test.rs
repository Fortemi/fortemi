...
//!
//! ```bash
//! # Using same models as dev/test (nomic-embed-text + gpt-oss)
...
async fn test_custom_config() {
    // This test just verifies we can create a backend with custom config
    // It doesn't actually make requests unless the endpoint exists
