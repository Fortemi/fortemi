...
//! - plainto_tsquery uses correct configuration
//!
...
mod text_search_config {
    ...
    fn test_search_uses_matric_english() {
        ...
        // - search() method: 3 to_tsvector + 3 plainto_tsquery = 6 occurrences
        // - search_with_strict_filter(): 3 to_tsvector + 3 plainto_tsquery = 6 occurrences
        // - search_filtered(): 3 to_tsvector + 3 plainto_tsquery = 6 occurrences
        // - search_by_keyword(): 1 plainto_tsquery = 1 occurrence
    ...
    fn test_sql_pattern_correctness() {
        ...
        // Check for plainto_tsquery('matric_english', ...) pattern
        assert!(
            search_source.contains("plainto_tsquery('matric_english'"),
            "search.rs should contain plainto_tsquery('matric_english', ...) pattern"
        );
    }
}
