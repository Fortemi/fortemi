...
export default [
  ...
  },
  {
    ...
    description: `Add knowledge to the active memory. Supports single notes, bulk import, template instantiation, and file uploads. See \`get_documentation(topic='notes')\` for revision modes and best practices.`,
    inputSchema: {
      "type": "object",
      "properties": {
        "action": {
  ...
  {
    name: "manage_tags",
    description: `List, set, or manage tags and SKOS concept tags on notes. See \`get_documentation(topic='concepts')\` for taxonomy details.`,
    inputSchema: {
      "type": "object",
      "properties": {
        "action": {
  ...
  },
  {
    ...
    description: `Browse, search, and inspect SKOS concepts (semantic tags). For heavy taxonomy editing (create/delete/relationships), see \`get_documentation(topic='concepts')\`.`,
    inputSchema: {
      "type": "object",
      "properties": {
        "action": {
          ...
          "description": "Action: 'search' (find concepts), 'autocomplete' (quick lookup), 'get'/'get_full' (details), 'stats' (governance), 'top' (root concepts)"
        },
        "q": {
          "type": "string",
        ...
        "scheme_id": {
          "type": "string",
          "format": "uuid",
          "description": "Filter by scheme UUID (for 'search'/'stats'/'top')"
        },
        "status": {
          "type": "string",
          "enum": [
