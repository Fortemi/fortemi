...
This document details the implementation of strict tag-based filtering for Matric Memory search. The feature enables guaranteed result segregation by SKOS concepts and schemes.
