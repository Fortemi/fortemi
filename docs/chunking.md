...
Matric Memory uses intelligent chunking strategies to split documents into semantically meaningful chunks for optimal embedding quality. This document covers the chunking module, available strategies, and usage guidelines.
