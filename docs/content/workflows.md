...
This guide explores the powerful combinations of Matric Memory's search tools, embedding sets, backup capabilities, and memory isolation features that enable sophisticated knowledge management workflows.

## Core Concepts

### The Memory Model

Matric Memory isn't just a note-taking system—it's a **contextual memory system** that:
...
Configure the AI to use Matric Memory as its knowledge store:
