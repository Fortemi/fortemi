...
This guide explains how matric-memory automatically constructs and traverses knowledge graphs.

## How It Works

### Automatic Link Creation

When you create a note, matric-memory:
...
```bash
curl "https://memory.integrolabs.net/api/v1/notes/{id}/links"
```
...
```bash
curl "https://memory.integrolabs.net/api/v1/graph/{id}/explore?depth=2&max_nodes=50"
```
...
curl "https://memory.integrolabs.net/api/v1/notes/{draft_id}/links"
```
...
curl "https://memory.integrolabs.net/api/v1/graph/{seed_id}/explore?depth=2"
```
