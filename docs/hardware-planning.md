...
This guide helps you choose the right hardware for running Matric Memory with local LLM inference, based on your quality requirements and budget.

## Overview

Matric Memory supports two inference backends:
