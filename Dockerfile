# Dockerfile - Standalone matric-memory API (requires external PostgreSQL)
#
# Usage:
#   docker build -t matric-memory:api .
#   docker run -d -p 3000:3000 -e DATABASE_URL=postgres://... matric-memory:api
#
