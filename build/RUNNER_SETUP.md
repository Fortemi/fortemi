...
- Access to `git.integrolabs.net` container registry
...
# Pull latest builder
docker pull git.integrolabs.net/roctinam/matric-memory/builder:latest
```
...
runner:
  labels:
    - "matric-builder:docker://git.integrolabs.net/roctinam/matric-memory/builder:latest"
...
act_runner register \
    --instance https://git.integrolabs.net \
    --token <YOUR_RUNNER_TOKEN> \
    --labels "matric-builder:docker://git.integrolabs.net/roctinam/matric-memory/builder:latest"
```
...
runner:
  labels:
    - "matric-builder-gpu:docker://git.integrolabs.net/roctinam/matric-memory/builder:gpu"
