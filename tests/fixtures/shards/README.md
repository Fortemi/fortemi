...
A reproducible candidate archive generated by
...
manifest, and blob digests plus the semantic assertions.

Runtime tests prove bounded archive parsing, exact inventory/count/checksum
validation, cross-component relationships, typed revision serialization,
mandatory-byte validation, sidecar deduplication, and archive
read/write/read equality. This is a candidate fixture, not a profile support
claim; signed export, supported route round trip, and cross-repository
